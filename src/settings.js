...
export function registerSettings() {
    ...
    register("portraitSize", { name: "L5RCTD.Setting.PortraitSize.Name", hint: "L5RCTD.Setting.PortraitSize.Hint", scope: "client", config: true, type: Number, range: { min: 48, max: 180, step: 4 }, default: 84 });
    ...
    register("portraitImage", { name: "L5RCTD.Setting.PortraitImage.Name", hint: "L5RCTD.Setting.PortraitImage.Hint", scope: "client", config: true, type: String, choices: { token: "L5RCTD.Setting.PortraitImage.Token", actor: "L5RCTD.Setting.PortraitImage.Actor" }, default: "token" });
    ...
    register("hideConflictingUi", { name: "L5RCTD.Setting.HideUi.Name", hint: "L5RCTD.Setting.HideUi.Hint", scope: "client", config: true, type: Boolean, default: false });
